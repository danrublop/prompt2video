...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`Testing simple video creation for: "${prompt}"`)
    ...
    // Create temp files
    const tempDir = path.join(process.cwd(), 'temp', `simple_test_${Date.now()}`)
    ...
    // Create video using the simplest possible FFmpeg command
